...
draw_text(20, 680, "Clique com botao direito para preview da carta");
draw_set_font(-1);
...
if (carta_preview != noone && instance_exists(carta_preview)) {
    ...
    var _escala_preview = 6; // ajuste esse número pro tamanho que quiser (2 = dobro, 4 = quádruplo, etc)
    ...
    draw_text_transformed(_centro_x, _centro_y - (_carta.sprite_height/2 * _escala_preview) + 10, _carta.nome_carta, _escala_preview * 0.5, _escala_preview * 0.5, 0);
    ...
    if (_carta.categoria == "tropa") {
        ...
        draw_text_transformed(_centro_x - (_carta.sprite_width/2 * _escala_preview) + 15, _centro_y + (_carta.sprite_height/2 * _escala_preview) - 10, _texto_atk, _escala_preview * 0.6, _escala_preview * 0.6, 0);
    ...
    // dica de como fechar
    draw_set_color(c_white);
    draw_text(_centro_x - 150, display_get_gui_height() - 40, "Clique com o botao direito pra fechar");
}
